...
class Contact(Resource):
    def post(self):
        data = request.json
        msg = Message('Contact form alert!', sender='tredr02@gmail.com', recipients=['tredr02@gmail.com'])
        msg.html = "Contact Email: " + data['email'] + "<br>" + "Contact Title: " + data['title'] + "<br>" + "Contact Description: " + data['description']
        mail.send(msg)
        client_msg = Message('Dear Client!', sender='tredr02@gmail.com', recipients=[data['email']])
...
api.add_resource(FooterItem, '/footer')
